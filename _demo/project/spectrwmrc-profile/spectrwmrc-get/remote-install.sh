...
# * https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/remote-install.sh
...
# * https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/spectrwmrc-get
...
## $ export DEBUG_SPECTRWMRC_GET_INSTALL=true
is_debug () {
	if [ "$DEBUG_SPECTRWMRC_GET_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="spectrwmrc-get-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/spectrwmrc-get
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/spectrwmrc-get'


	THE_TARGET_FILE_NAME="spectrwmrc-get"
