...
is_debug () {
	if [ "$DEBUG_SPECTRWMRC_GET" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	## https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/spectrwmrc-get
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-get/spectrwmrc-get'
