...
# * https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/remote-install.sh
# * https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl
# * https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl
...
## $ export DEBUG_SPECTRWMRC_CTRL_INSTALL=true
is_debug () {
	if [ "$DEBUG_SPECTRWMRC_CTRL_INSTALL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME="spectrwmrc-ctrl-install"
	fi
	...
	## Target
	## https://github.com/samwhelp/note-about-spectrwm/blob/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl
	THE_TARGET_DOWNLOAD_URL='https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl'


	THE_TARGET_FILE_NAME="spectrwmrc-ctrl"
