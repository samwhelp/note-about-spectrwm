...
is_debug () {
	if [ "$DEBUG_SPECTRWMRC_CTRL" = "true" ]; then
		return 0
	fi
...
base_var_init () {
	...
	if [ "none${THE_CMD_FILE_NAME}" = 'none' ]; then
		THE_CMD_FILE_NAME='spectrwmrc-ctrl'
	fi

	THE_CMD_FILE_PATH="${THE_CMD_DIR_PATH}/$THE_CMD_FILE_NAME"

	## https://github.com/samwhelp/play-ubuntu-20.04-plan/blob/master/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl
	THE_SELF_UPDATE_URL='https://raw.githubusercontent.com/samwhelp/note-about-spectrwm/gh-pages/_demo/project/spectrwmrc-profile/spectrwmrc-ctrl/spectrwmrc-ctrl'
	...
	THE_SPECTRWMRC_FILE_NAME="spectrwm.conf"
	THE_SPECTRWMRC_FILE_PATH="$THE_SPECTRWMRC_DIR_PATH/$THE_SPECTRWMRC_FILE_NAME"

	## spectrwmrc-profile
	THE_SPECTRWMRC_PROFILE_DIR_NAME="spectrwmrc-profile"
	THE_SPECTRWMRC_PROFILE_DIR_PATH="$HOME/.local/share/$THE_SPECTRWMRC_PROFILE_DIR_NAME"
...
base_var_dump () {
	...
	util_debug_echo "THE_SPECTRWMRC_DIR_NAME=$THE_SPECTRWMRC_DIR_NAME"
	util_debug_echo "THE_SPECTRWMRC_DIR_PATH=$THE_SPECTRWMRC_DIR_PATH"

	util_debug_echo "THE_SPECTRWMRC_FILE_NAME=$THE_SPECTRWMRC_FILE_NAME"
	util_debug_echo "THE_SPECTRWMRC_FILE_PATH=$THE_SPECTRWMRC_FILE_PATH"
